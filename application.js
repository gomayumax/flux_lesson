...
var EventEmitter = function () {
  ...
  _createClass(EventEmitter, [{
    key: 'on',
    value: function on(tyepe, handler) {
      if (typeof this._handler[tyepe] === 'undefined') {
        this._handlers[type] = [];
      }
 ...
 * Created by m_ishikawa on 2017/08/12.
 */
_react2.default.render(_react2.default.createElement(_Component2.default), document.body);
...
var ActionCreator = function () {
  function ActionCreator(dispacher) {
  ...
  _createClass(ActionCreator, [{
    ...
    value: function countUp(data) {
      this.dispacher.emit("countUp", data);
    }
  }]);
...
var Store = function (_Emitter) {
  ...
  function Store(dispatcher) {
    ...
    _this.count = 0;
    dispatcher.on("countUp", _this.onCountUp.bind(_this));
    return _this;
  }
